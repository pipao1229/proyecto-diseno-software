...
SECRET_KEY = 'django-insecure-PON-AQUI-UNA-CLAVE-SECRETA-ALEATORIA'
...
ROOT_URLCONF = 'campaign_analyzer.urls'
...
WSGI_APPLICATION = 'campaign_analyzer.wsgi.application'
...
# Archivos subidos por el usuario (datasets)
MEDIA_URL = '/media/'
